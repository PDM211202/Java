...
public class ArticleObject {
    ...
    private short article_isfee;
    private short article_delete;
    ...
    private short article_language;
    private short article_focus;
    private short article_type;
    private short article_forhome;
	...
	public short getArticle_enable() {
		return article_enable;
	}

	public void setArticle_enable(short article_enable) {
	...
	public short getArticle_isfee() {
		return article_isfee;
	}

	public void setArticle_isfee(short article_isfee) {
		this.article_isfee = article_isfee;
	}

	public short getArticle_delete() {
		return article_delete;
	}

	public void setArticle_delete(short article_delete) {
	...
	public short getArticle_language() {
		return article_language;
	}

	public void setArticle_language(short article_language) {
		this.article_language = article_language;
	}

	public short getArticle_focus() {
		return article_focus;
	}

	public void setArticle_focus(short article_focus) {
		this.article_focus = article_focus;
	}

	public short getArticle_type() {
		return article_type;
	}

	public void setArticle_type(short article_type) {
		this.article_type = article_type;
	}

	public short getArticle_forhome() {
		return article_forhome;
	}

	public void setArticle_forhome(short article_forhome) {
		this.article_forhome = article_forhome;
	}

	public String toString() {
		return "ID: " + this.article_id + "\tTITLE: " + this.article_title;
	}
